        ...
        <div className="min-h-screen bg-sitou-surface md:bg-white flex flex-col max-w-3xl mx-auto md:shadow-xl md:min-h-0 md:h-screen">
            <header className="p-4 bg-white border-b border-gray-100 sticky top-0 z-20 flex items-center justify-between">
                ...
                <div className="flex items-center text-sitou-primary font-bold bg-amber-50 px-3 py-1 rounded-full text-xs">
                    ...
                    {lesson.sections ? 'Leçon' : 'Micro-leçon'} &bull; {lesson.durationMinutes} min
                </div>
            </header>
            ...
            <main className="flex-1 overflow-y-auto p-6 md:p-10">
                ...
                {lesson.summary && !lesson.sections && (
                ...
                <div
                    className={`mt-6 border-2 rounded-2xl p-4 cursor-pointer transition-all ${understood ? 'border-green-200 bg-green-50' : 'border-gray-200 bg-white hover:border-amber-200'}`}
            ...
            <footer className="p-4 md:p-6 border-t border-gray-100 bg-white sticky bottom-0 z-20">
                ...
                >
                    {understood ? "Passer aux exercices" : "Retour"}
                </Button>
            </footer>
        </div>
    );
